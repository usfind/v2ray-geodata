...
GEOIP_URL:=https://github.com/cnfind/geo-rules/releases/download/mihomo/geoip.dat
GEOSITE_URL:=https://github.com/cnfind/geo-rules/releases/download/mihomo/geosite.dat
